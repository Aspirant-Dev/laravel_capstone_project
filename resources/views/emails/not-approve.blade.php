  ...
  <body>
    ...
    <main style="">
        <div id="notices">
            ...
            <br>
                <div>
                    <h2>We just want to inform that your request of return product on {{ date('j F Y (g:i a)', strtotime($productDetails->created_at)) }} was not approved.<br/>
                    <br/>
                    <br>

                        Reason why the request was not approved due to: {{ $productDetails->message }}
                    </h2>
                </div>
        </div>
        <br>
        <div><h2>Your item are as below :</h2></div>
      <table>
        <thead>
          <tr>
