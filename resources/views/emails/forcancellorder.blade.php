  ...
  <body>
    <header class="clearfix">
      ...
      <div id="notices">
        ...
        <br>
        <div>
            <h2>We just want to inform that your Order #{{ $tracking_no }} on {{ date('j F Y (g:i a)', strtotime($orders->created_at)) }} has been cancelled.
                <br>
                <br>

                Reason why the order(s) has been cancelled due to: <strong>Incorrect GCash Receipt Image</strong>
            </h2>
        </div>
      </div>
    </header>
