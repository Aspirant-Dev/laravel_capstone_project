        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card card-info" style="border-radius: 0px!important">
                ...
                <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            @endif
                            <td><img src="{{ asset('uploads/categories/'.$item->image) }}" alt="image" width="100px" height="100px"></td>
                            <td>{{ date('M-d-Y', strtotime($item->created_at)) }}</td>
                            <td align="center">
                                <a href="{{ url('/admin/edit-category/'.$item->id) }}" type="button" class="btn btn-sm btn-primary" >Update</a>
