            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row mt-1 mb-3">
                        <div class="col-md-4">
                            <a href="{{ url('/admin/add-user-account') }}" class="btn btn-success">Add User Account</a>
                        ...
                        <div class="col-12">
                                <div class="card card-info">
                                    <div class="card-header">
                                        <h3 class="card-title">User Management DataTable</h3>
                                        ...
                                        <tbody>
                                            @foreach ($admins as $item)
                                                <tr>
                                                    ...
                                                    @endif
                                                    <td align="center">
                                                        <a href="{{ url('admin/edit-user-account/'.$item->id) }}" type="button" class="btn btn-sm btn-primary" >Update</a>
                                                        <a type="button" class="btn btn-danger btn-sm deletebtn">Delete</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
...
<script>
    $(document).ready(function () {
        ...
        $('.deletebtn').click(function (e) {
            ...
            swal({
                title: "Are you sure?",
                text: "Once deleted, you can be able to recover this "+del_name+" account on restore module.",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
