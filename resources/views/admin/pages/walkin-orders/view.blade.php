        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="{{ route('admin.walkin.orders') }}" type="button" class="btn  bg-gradient-info" style="margin-right: 15px;"><i class="fas fa-undo-alt"></i> Back</a>
                            <button onclick="generatePDF();" type="button" class="btn btn-flat btn-default" style="margin-right: 5px;">
