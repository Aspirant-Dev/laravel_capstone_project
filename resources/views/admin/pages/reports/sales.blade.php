...
<html lang="en">
    <head>
        ...
        <title>Online Transaction Sales Report</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Online Transaction Sales Report</h1>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.reports.online.sales.search-from-date') }}" method="post">
                                    @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <a href="{{ route('admin.reports.online.sales') }}"><li class="dropdown-item">Today</li></a>
                                                        <a href="{{ route('admin.reports.online.sales.yesterday') }}"><li class="dropdown-item">Yesterday</li></a>
                                                        <a href="{{ route('admin.reports.online.sales.last-7-days') }}"><li class="dropdown-item">Last 7 Days</li></a>
                                                        <a href="{{ route('admin.reports.online.sales.this-month') }}"><li class="dropdown-item">This Month (30 Days)</li></a>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div id="invoice">
                                <div class="card p-3"  style="border-radius: 0px!important">
                                    <div class="card-header" style="border-bottom: none!important">
                                        <h3 class="text-center mb-0">Online Transaction Sales Report</h3>
                                        <br>
                                        <small class=" text-center">
                                            <strong>
                                                @php if(Route::is('admin.reports.online.sales.search-from-date'))
                                                        echo 'As of: '. Session::get('searched').'<br><span class="noPrint" style=font-style:italic> (Last Searched) </span>';
                                                     elseif(Route::is('admin.reports.online.sales.yesterday'))
                                                     ...
                                                     elseif(Route::is('admin.reports.online.sales.last-7-days'))
                                                        echo 'As of: '.$range.'<br><span class="noPrint" style=font-style:italic> (Filtered by : Last 7 Days) </span>';
                                                     elseif(Route::is('admin.reports.online.sales.this-month'))
