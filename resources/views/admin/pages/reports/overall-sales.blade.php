        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Overall Transaction Sales Report</h1>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="d-flex">
                                <div class="mr-auto p-2">
                                    ...
                                    <ul class="dropdown-menu">
                                        <a href="{{ route('admin.reports.online.sales') }}"><li class="dropdown-item">Online Transaction Report</li></a>
                                        <a href="{{ route('admin.reports.walkin.sales') }}"><li class="dropdown-item">Walk-in Transaction Report</li></a>
                                    </ul>
                                </div>
                                <div class="p-2">
                                    <a href=""   target="_blank" class="btn btn-success "><i class="fas fa-print"></i> Generate PDF</a>
                                </div>
                                <div class="p-2">
                                    <a onclick="window.print();" type="button" style="margin-right: 10px;" class="btn btn-success "><i class="fas fa-print"></i> Print</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.reports.overall.sales.search-from-date') }}" method="post">
                                    @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <a href="{{ route('admin.reports.overall.sales') }}"><li class="dropdown-item">Today</li></a>
                                                        <a href="{{ route('admin.reports.overall.sales.yesterday') }}"><li class="dropdown-item">Yesterday</li></a>
                                                        <a href="{{ route('admin.reports.overall.sales.last-7-days') }}"><li class="dropdown-item">Last 7 Days</li></a>
                                                        <a href="{{ route('admin.reports.overall.sales.this-month') }}"><li class="dropdown-item">This Month (30 Days)</li></a>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div id="invoice">
                                <div class="card p-3"  style="border-radius: 0px!important">
                                    <div class="card-header" style="border-bottom: none!important">
                                        <h3 class="text-center mb-0">Overall Transaction Sales Report</h3>
                                        <br>
                                        <small class=" text-center">
                                            <strong>
                                                @php if(Route::is('admin.reports.overall.sales.search-from-date'))
                                                        echo 'As of: '. Session::get('searched').'<br><span class="noPrint" style=font-style:italic> (Last Searched) </span>';
                                                     elseif(Route::is('admin.reports.overall.sales.yesterday'))
                                                     ...
                                                     elseif(Route::is('admin.reports.overall.sales.last-7-days'))
                                                        echo 'As of: '.$range.'<br><span class="noPrint" style=font-style:italic> (Filtered by : Last 7 Days) </span>';
                                                     elseif(Route::is('admin.reports.overall.sales.this-month'))
                                                    ...
                                                    <table id="example2" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($query as $item)
                                                                <tr class="text-center">
                                                                    <td>{{ $item->id }}</td>
                                                                    <td>{{ date('M-d-Y', strtotime($item->trans_Date)) }}</td>
                                                                    <td>{{ $item->cus_name }}</td>
                                                                    <td>{{ $item->invoice }}</td>
...
<script>
    function generatePDF()
    {
        ...
        html2pdf()
        .from(element)
        .save('Online Sales Report | <?php echo $name; ?>');
    }
</script>
</body>
</html>
