...
<html lang="en">
    <head>
        ...
        <title>Admin | Restore Products</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Restore Products </h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Restore Products </li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            @if($products->count() > 1)
                <div class="row mt-1 mb-3">
                    <div class="col-md-4">
                        <a href="{{ route('products.restore-all') }}" class="btn btn-success">
                        ...
                        <tbody>
                            @foreach ($products as $item)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="{{ route('products.restore', $item->id) }}" type="button" class="btn btn-sm btn-success">Restore</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
