                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="border-radius: 0px;">
                                <div class="card-body" >
                                    <form class="needs-validation" novalidate action="{{ url('/admin/update-banner/'.$banner->id)}}" method="POST"  enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="title" id="summernote1" required value="{{ $banner->title }}" placeholder="Enter banner title"/>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="summernote2" name="subtitle" value="{{ $banner->subtitle }}" required placeholder="Enter banner subtitle"/>
                                                    <div class="invalid-feedback text-start fw-bold">This field is required.</div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                      <div class="form-group">
                                                        <div class="form-check">
                                                          <input class="form-check-input" {{ $banner->status  == "1" ? 'checked':'' }}  style="cursor: pointer" id="status" name="status" type="checkbox">
                                            ...
                                            <div class="col-sm-12">
                                              <!-- Category Image -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img src="{{ asset('uploads/banners/'.$banner->image) }}" width="1170px" height="500px"  alt="Banner Img" >
                                                    <br>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input onchange="loadFile(event)" class="form-control @error('image') is-invalid @endif" type="file" name="banner_image" accept="image/png, image/gif, image/jpeg"/>
...
{{-- <script>
    $(function () {
      ...
      $('#summernote2').summernote({
          placeholder: 'Enter banner subtitle here...',
            spellcheck: true,
          toolbar: [
            // [groupName, [list of button]]
            ['style', ['bold', 'italic', 'underline', 'clear']],
