            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row mt-1 mb-3">
                        <div class="col-md-4">
                            <a href="{{ route('admin.add.banner') }}" class="btn btn-success">Add Banner</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                        ...
                                        <tbody>
                                            @foreach ($banners as $item)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/admin/edit-banner/'.$item->id) }}" type="button" class="btn btn-sm btn-primary ">Update</a>
...
<script>
    $(document).ready(function () {
        ...
        $('.deletebtn').click(function (e) {
            ...
            swal({
                title: "Are you sure?",
                text: "Once deleted, you able to recover or restore this banner on the trash.",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
