      ...
      <div class="row">
        ...
        <div class="col-xs-6 col-md-3">
          ...
          <ul class="footer-links">
            ...
            {{-- <li><a href="#"data-bs-toggle="modal" data-bs-target="#staticBackdrop">Privacy Policy</a></li> --}}
          </ul>
        </div>
      </div>
      <hr>
       ...
       <a href="#" style="text-decoration: none">Real Value Enterprise</a>.
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <ul class="social-icons">
            <li><a  href="https://www.facebook.com/REAL-VALUE-Enterprises-100441979037579" target="_blank"><i class="fab fa-facebook"></i></a></li>
            <li><a href="https://www.linkedin.com/in/renz-joseph-castelo-4522021b9" target="_blank"><i class="fab fa-linkedin"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
