        ...
        @if (Auth::user()->user_type == 'Admin')
            ...
            <li class="nav-item @if (Route::is('admin.add-product') || Route::is('admin.edit-product') || Route::is('admin.add-category') || Route::is('admin.edit-category') || Route::is('admin.add-product-unit') || Route::is('admin.products-unit') || Route::is('admin.edit-product-unit') || Route::is('admin.banners')  ||(Route::is('admin.add.banner')) || Route::is('admin.edit.banner') || Route::is('admin.ratings') || Route::is('admin.add-user') || Route::is('admin.edit-user')) menu-open @endif">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('admin.add-user') }}" class="nav-link @if (Route::is('admin.add-user') || Route::is('admin.edit-user')) active @endif">
                      <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item @if(Route::is('admin.user-management')) menu-open @endif">
                <a href="{{ url('/admin/user-management') }}" class="nav-link @if(Route::is('admin.user-management')) active @endif">
