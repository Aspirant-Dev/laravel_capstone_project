...
@section('content')
    ...
    {{-- <main class="main"> --}}
        ...
        <div class="bg-light pt-5 pb-10" style="background-color: rgb(234, 243, 255)!important;">
            <div class="container-fluid">
                <div class="heading heading-center mb-3">
                    <h2 class="title-lg" style="font-weight: 500;">New Arrivals</h2><!-- End .title -->
                </div><!-- End .heading -->
        ...
        @endphp
        <div class=" pt-5 pb-10" style="background-color: rgb(234, 243, 255)!important; margin-top: -80px">
            <div class="container-fluid" style="background-color: rgb(234, 243, 255)!important;">
                <h2 class="title-lg" style="font-weight: 500;"><center>Shop by Category</center></h2><!-- End .title -->
                        ...
                        <div class="col-sm-6 col-md-3 ">
                            <div class="banner banner-cat ban-cat" style="border: 1px solid rgba(187, 187, 187, 0.658) !important" height="10px;">
                                <a style="cursor: pointer">
                                    <img src="{{ asset('uploads/categories/'.$item->image) }}" width="100%" style="background-size: cover!important;  " alt="Banner">
                                </a>
                                ...
                                <div class="banner-content banner-content-overlay text-center">
                                    ...
                                    @endphp
                                    <h3 class="banner-title font-weight-bold">{{ $item->name }} </h3><!-- End .banner-title -->
        ...
        <div class=" pt-5 pb-10" style="background-color: rgb(234, 243, 255)!important; margin-top: -100px">
            <div class="container-fluid" style="background-color: rgb(234, 243, 255)!important;">
                <div class="heading heading-center ">
                    <h2 class="title-lg mb-2" style="font-weight: 500;">All Products</h2><!-- End .title-lg text-center -->
                </div><!-- End .heading -->
                        ...
                        <div class="products just-action-icons-sm">
                            <div class="row">
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col ">
                                    <div class="product product-3 text-center product_data m-2 border">
                                        ...
                                        <div class="product-body ">
                                            <div class="product-cat">
                                                <a style="color: rgb(110, 110, 110)"  href="{{ url('view-category/'.$item->category->slug) }}">{{ $item->cate_name }}</a>
                                            </div><!-- End .product-cat -->
                                            <h3 class="product-title font-weight-bold"><a href="{{ url('category/'.$item->category->slug.'/'.$item->slug) }}">{{ $item->name }}</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                <span class="new-price">&#8369; {{ number_format($item->price,2) }}</span>
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                        ...
                                        @endif
                                            <div class="product-action ">
                                                ...
                                                @if($item->stocks > 0)
                                                    @if(Auth::check())
                                                        @if(!Auth::user()->email_verified_at)
                                                            <a href="javascript:void(0);" class="btn-product btn-cart" onclick="swal({title:'Please verify your email to continue.',icon:'info'});" title="Add to Cart"></a>
                                                        @else
                                                            <a href="#" class="btn-product btn-cart btnCart"  title="Add to Cart"></a>
                                                        @endif
                                                    @else
                                                        <a href="javascript:void(0);" class="btn-product btn-cart" onclick="swal({title:'Login to continue.',icon:'info'});" title="Add to Cart"></a>
                                                    @endif
                                                @else
                                                    <a href="javascript:void(0);" class="btn-product btn-cart" onclick="swal({title:'Out of Stock.',icon:'error'});" title="Add to Cart"></a>
                                                @endif
                                                {{-- <a href="#" class="btn-product btn-cart btnCart" title="Add to cart"></a> --}}
