                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.cashier.reports.walkin.sales.search-from-date') }}" method="post">
                                    @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <a href="{{ route('admin.cashier.reports.walkin.sales') }}"><li class="dropdown-item">Today</li></a>
                                                        <a href="{{ route('admin.cashier.reports.walkin.sales.yesterday') }}"><li class="dropdown-item">Yesterday</li></a>
                                                        <a href="{{ route('admin.cashier.reports.walkin.sales.last-7-days') }}"><li class="dropdown-item">Last 7 Days</li></a>
                                                        <a href="{{ route('admin.cashier.reports.walkin.sales.this-month') }}"><li class="dropdown-item">This Month (30 Days)</li></a>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <div class="card "  style="border-radius: 0px!important">
                                    <div class="card-header" style="border-bottom: none!important">
                                        ...
                                        <small class=" text-center">
                                            <strong>
                                                @php if(Route::is('admin.cashier.reports.walkin.sales.search-from-date'))
                                                        echo 'As of: '. Session::get('searched').'<br><span class="noPrint" style=font-style:italic> (Last Searched) </span>';
                                                     elseif(Route::is('admin.cashier.reports.walkin.sales.yesterday'))
                                                     ...
                                                     elseif(Route::is('admin.cashier.reports.walkin.sales.last-7-days'))
                                                        echo 'As of: '.$range.'<br><span class="noPrint" style=font-style:italic> (Filtered by : Last 7 Days) </span>';
                                                     elseif(Route::is('admin.cashier.reports.walkin.sales.this-month'))
...
<script>
    function generatePDF()
    {
        ...
        html2pdf()
        .from(element)
        .save('Walkin Sales Report | <?php echo $name; ?>');
    }
</script>
</body>
</html>
