                                            ...
                                            <table class="table table-bordered" width="100%">
                                                <thead>
                                                    <tr class="text-center">
                                                        ...
                                                        <th width="20%">Product Name<span style="font-size: 1.1rem; " class="text-danger fw-bold">*</span></th>
                                                        <th width="15%">Brand</th>
                                                        <th width="15%">Type</th>
                                                        <th width="15%">Unit</th>
                                                        <th width="8%">Qty<span style="font-size: 1.1rem; " class="text-danger fw-bold">*</span></th>
                                                        ...
                                                        <td>
                                                            <select required class="form-control product_id select2bs4" name="product_id[]" id="product_id" style="width: 100%; margin-bottom: 14px;">
                                                                ...
                                                                @foreach ($products as $item)
                                                                    <option data-brand="{{ $item->brand }}" data-type="{{ $item->product_type }}" data-unit="{{ $item->unit  }}" data-price="{{ $item->price }}" value="{{ $item->id }} ">{{ $item->name }}</option>
                                                                @endforeach
                                                              </select>
                                                        </td>
                            ...
                            <div class="sticky-top mb-3">
                              <div class="card" style="border-radius: 0px!important;">
                                    ...
                                    <div class="row bg-light">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" class="form-control" name="name" placeholder="Enter Customer Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row bg-light">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label >{{ __('Contact No.') }}<small style="font-style: italic"> (09xx-xxx-xxxx)</small></label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input style="text-align: right; font-weight:bold" required id="paid_amount" type="number"
                                                            class="form-control paid_amount" name="paid_amount" placeholder="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input required  type="text" readonly id="balance" class="form-control" name="balance"  style="background-color: white; font-weight:bold; text-align:right;" placeholder="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-block bg-gradient-success">Receive Payment</button>
                                </div>
                              </div>
                            </div>
                        </div>
