                        ...
                        <div class="tab-pane fade  @if(Route::is('login')) show active @endif " id="signin-2" role="tabpanel" aria-labelledby="signin-tab-2">
                            <form method="post" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <label for="singin-email-2" style="font-weight: 500;">Username  *</label>
                                ...
                                <div class="form-footer mt-1">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="signin-remember-2" style="font-weight: 500;">Remember Me</label>
                                    </div><!-- End .custom-checkbox -->

                                    <a href="{{ route('password.request') }}" class="forgot-link" style="font-weight: 500;">Forgot Your Password?</a>
                                </div><!-- End .form-footer -->
                        ...
                        <div class="tab-pane fade @if(Route::is('register')) show active @endif " id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
                            <form method="POST" action="{{ route('register') }}" oninput='password_confirmation.setCustomValidity(password_confirmation.value != password.value ? "Passwords do not match." : "")'>
                                ...
                                <div class="form-group row">
                                    <!-- Password -->
                                    <div class="col-md-6">
                                        <label style="font-weight: 500;" style="font-weight: 500;" for="password1">Password *</label><br>
                                        <div class="input-group">
                                    ...
                                    <!-- Confirm Password -->
                                    <div class="col-md-6">
                                        <label style="font-weight: 500;" for="password-confirm" class="col-form-label">{{ __('Confirm Password *') }}</label>
                                        <div class="input-group">
